                    ...
                    <div class="col-xs-6 col-sm-6">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                ...
                                @endif
                            <form method="POST" action="{{ route('member.update', $member->id_member) }}" id="myForm">
                            @csrf
                            @method('PUT')
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="nama_member" name="nama_member" class="form-control" id="nama_member" ariadescribedby="nama_member" value="{{ old('nama_member', $member->nama_member) }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"></div>
                                        <input type="Date" name="tgl_lahir" class="form-control" id="tgl_lahir" ariadescribedby="tgl_lahir" value="{{ old('tgl_lahir', $member->tgl_lahir) }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"></div>
                                        <input type="alamat" name="alamat" id="alamat" class="form-control" ariadescribedby="alamat" value="{{ old('alamat', $member->alamat) }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"></div>
                                        <input type="no_telp" name="no_telp" id="no_telp" class="form-control" ariadescribedby="no_telp" value="{{ old('no_telp', $member->no_telp) }}">
                                    </div>
                                </div>
