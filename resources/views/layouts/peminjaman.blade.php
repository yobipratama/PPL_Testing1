                  ...
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    @foreach ($peminjaman as $key)
                      <tr>
                        ...
                        <td>
                            <form action="{{ route('peminjaman.destroy',['peminjaman'=>$key->id_peminjaman]) }}" method="POST">
                                <a class="btn btn-primary" href="{{ route('peminjaman.edit',$key->id_peminjaman) }}">Edit</a>
                                @csrf
                                @method('DELETE')
