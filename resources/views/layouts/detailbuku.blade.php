                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Detail Buku</strong>
                        </div>
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                            <li class="list-group-item"><b>Judul Buku : </b>{{$buku->judul_buku}}</li>
                            <li class="list-group-item"><b>Nama Pengarang : </b>{{$buku->nama_pengarang}}</li>
                            <li class="list-group-item"><b>Nama Penerbit : </b>{{$buku->nama_penerbit}}</li>
                            <li class="list-group-item"><b>Ketebalan : </b>{{$buku->ketebalan}}</li>
                            <li class="list-group-item"><b>Tahun Terbit : </b>{{$buku->tahun_terbit}}</li>
                            <li class="list-group-item"><b>Jumlah Buku : </b>{{$buku->jumlah_buku}}</li>
                            <li class="list-group-item"><b>Foto : </b><img width="200px" src="{{ asset('storage/'.$buku->image) }}"></li>
                </ul>
                    </div>
