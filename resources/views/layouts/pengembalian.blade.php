            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                        <div class="btn">
                        <a class="btn btn-success" href="{{ route('pengembalian.create') }}"> Tambah Data Pengembalian </a>
                        </div><br>
                        <div class="btn">
                        <a class="btn btn-info" href="/print" target="_blank"> Print PDF </a>
                        </div>
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    @foreach ($pengembalian as $key)
                      <tr>
                        ...
                        <td>{{ $key -> keadaan }}</td>
                        <td>
                            <form action="{{ route('pengembalian.destroy',['pengembalian'=>$key->id_pengembalian]) }}" method="POST">
                                <a class="btn btn-primary" href="{{ route('pengembalian.edit',$key->id_pengembalian) }}">Edit</a>
                                @csrf
                                @method('DELETE')
