                    ...
                    <div class="col-xs-6 col-sm-6">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                ...
                                @endif
                            <form method="POST" action="{{ route('pengembalian.update', $pengembalian->id_pengembalian) }}" id="myForm">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <option selected disabled value="{{ old('nama_member', $pengembalian->nama_member) }}">Pilih Member</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <option selected disabled value="{{ old('judul_buku', $pengembalian->judul_buku) }}">Pilih Judul Buku</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="Date" name="tgl_pinjam" class="form-control" id="tgl_pinjam" ariadescribedby="tgl_pinjam" value="{{ old('tgl_pinjam', $pengembalian->tgl_pinjam) }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"></div>
                                        <input type="Date" name="tgl_kembali" class="form-control" id="tgl_kembali" ariadescribedby="tgl_kembali" value="{{ old('tgl_kembali', $pengembalian->tgl_kembali) }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="denda" class=" form-control-label">Denda</label>
                                    <div class="input-group">
                                        <div class="input-group-addon"></div>
                                        <input type="denda" name="denda" class="form-control" id="denda" ariadescribedby="denda" value="{{ old('denda', $pengembalian->denda) }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="keadaan" class=" form-control-label">Keadaan</label>
                                    <div class="input-group">
                                        <div class="input-group-addon"></div>
                                        <input type="keadaan" name="keadaan" class="form-control" id="keadaan" ariadescribedby="keadaan" value="{{ old('keadaan', $pengembalian->keadaan) }}">
                                    </div>
                                </div>
