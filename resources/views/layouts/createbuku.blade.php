                            ...
                            @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="judul_buku" name="judul_buku" class="form-control" id="judul_buku" ariadescribedby="judul_buku">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"></div>
                                        <input type="nama_pengarang" name="nama_pengarang" id="nama_pengarang" class="form-control" ariadescribedby="nama_pengarang">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"></div>
                                        <input type="nama_penerbit" name="nama_penerbit" id="nama_penerbit" class="form-control" ariadescribedby="nama_penerbit">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"></div>
                                        <input type="ketebalan" name="ketebalan" id="ketebalan" class="form-control" ariadescribedby="ketebalan">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"></div>
                                        <input type="date" name="tahun_terbit" id="tahun_terbit" class="form-control" ariadescribedby="tahun_terbit">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"></div>
                                        <input type="jumlah_buku" name="jumlah_buku" id="jumlah_buku" class="form-control" ariadescribedby="jumlah_buku">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"></div>
                                        <input type="file" name="image" id="image" class="form-control" required="required" aria-describedby="image">
                                        @error('image')
