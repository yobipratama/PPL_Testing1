                    ...
                    <div class="col-xs-6 col-sm-6">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                ...
                                @endif
                            <form method="POST" action="{{ route('peminjaman.update', $peminjaman->id_peminjaman) }}" id="myForm">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <option selected disabled value="{{ old('nama_member', $peminjaman->nama_member) }}">Pilih Member</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <option selected disabled value="{{ old('judul_buku', $peminjaman->judul_buku) }}">Pilih Judul Buku</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="Date" name="tgl_pinjam" class="form-control" id="tgl_pinjam" ariadescribedby="tgl_pinjam" value="{{ old('tgl_pinjam', $peminjaman->tgl_pinjam) }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"></div>
                                        <input type="Date" name="tgl_kembali" class="form-control" id="tgl_kembali" ariadescribedby="tgl_kembali" value="{{ old('tgl_kembali', $peminjaman->tgl_kembali) }}">
                                    </div>
                                </div>
