                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Detail Member</strong>
                        </div>
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                            <li class="list-group-item"><b>Nama Member : </b>{{$member->nama_member}}</li>
                            <li class="list-group-item"><b>Tanggal Lahir : </b>{{$member->tgl_lahir}}</li>
                            <li class="list-group-item"><b>Alamat : </b>{{$member->alamat}}</li>
                            <li class="list-group-item"><b>No. Telpon : </b>{{$member->no_telp}}</li>
                </ul>
                    </div>
                    <a class="btn btn-success mt-3" href="{{ route('member.index') }}">Back</a>
                 </div>
                </div>
