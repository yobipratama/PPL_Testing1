                    ...
                    <div class="col-xs-6 col-sm-6">
                        <div class="card">
                            <div class="card-header">
                                <strong>Input Data Pengembalian</strong>
                            </div>
                            <div class="card-body card-block">
                                ...
                                @endif
                            <form method="POST" action="{{ route('pengembalian.store') }}" id="myForm">
                            @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"></div>
                                        <input type="denda" name="denda" class="form-control" id="denda" ariadescribedby="denda">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"></div>
                                        <input type="keadaan" name="keadaan" class="form-control" id="keadaan" ariadescribedby="keadaan">
                                    </div>
                                </div>
